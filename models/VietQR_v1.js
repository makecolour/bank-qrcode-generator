...
export var FIELDS = {
    ...
    acq: "970403",
    merchant_id: "",
    service_code: SERVICE_CODE.account,
    bill_number: "",
    mobile_number: "",
    store_label: "",
    loyalty_number: "",
...
export const CRC = {
    ...
    getCrc16_array(text, hex_output = true) {
        ...
        let result = text.map(row => row.map(string => {
            ...
            crc &= 0xffff;
            return hex_output ? crc.toString(16).padStart(4, '0').toUpperCase() : crc;
        }));
...
export { VIETQR, SERVICE_CODE, CURRENCY };
